    ...
    useEffect(() => {
        const fetchWallet = async () => {
            ...
            try {
                ...
                setError(err.message || "Could not load your wallet balance.");
            } finally {
                setLoading(false);
            }
        };
            ...
            <div style={styles.content}>
                ...
                <div style={styles.actions}>
                    ...
                    <Link
                        ...
                        style={{
                            ...styles.actionButton,
                            ...(hoveredAction === "chain-verify" ? styles.actionButtonHover : {}),
                        }}
                        onMouseEnter={() => setHoveredAction("chain-verify")}
                        onMouseLeave={() => setHoveredAction(null)}
                    >
                        Verify Chain
                    </Link>
                    <Link
                        ...
                        style={{
                            ...styles.actionButton,
                            ...(hoveredAction === "transactions" ? styles.actionButtonHover : {}),
                        }}
                        onMouseEnter={() => setHoveredAction("transactions")}
                        onMouseLeave={() => setHoveredAction(null)}
                    >
                        History
                    </Link>
