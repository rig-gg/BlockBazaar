...
const styles = {
  ...
  card: { padding: "1.8rem", display: "flex", flexDirection: "column", gap: "1.2rem" },
  cardHeader: { display: "flex", alignItems: "center", gap: "0.65rem" },
  iconCircle: {
  ...
  summaryLabel: { fontSize: "0.85rem", color: "#94A3B8" },
  summaryVal: { fontSize: "0.9rem", fontWeight: "600", color: "#F8FAFC" },
  noticeBox: {
    display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.8rem", color: "#94A3B8",
    background: "rgba(15, 23, 42, 0.6)", padding: "0.6rem 0.8rem", borderRadius: "8px",
  },
};
