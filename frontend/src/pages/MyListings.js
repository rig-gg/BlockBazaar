...
const styles = {
  ...
  layoutGrid: {
    ...
    gap: "1.8rem", alignItems: "flex-start",
  },
  formCard: { padding: "1.8rem", display: "flex", flexDirection: "column", gap: "1.2rem" },
  formHeader: { display: "flex", alignItems: "center", gap: "0.65rem" },
  iconCircle: {
  ...
  priceContainer: { display: "flex", alignItems: "baseline", gap: "0.35rem" },
  priceNum: { fontFamily: "var(--font-heading)", fontSize: "1.6rem", fontWeight: "800", color: "#38BDF8" },
  priceUnit: { fontSize: "0.85rem", fontWeight: "600", color: "#94A3B8" },
  emptyBox: {
